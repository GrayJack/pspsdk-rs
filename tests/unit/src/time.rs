...
// #[test]
pub fn instant_math_is_associative() {
    let now = Instant::now();
...
// #[test]
pub fn instant_duration_since_saturates() {
    let a = Instant::now();
...
// #[test]
pub fn instant_checked_duration_since_nopanic() {
    let now = Instant::now();
...
// #[test]
pub fn instant_saturating_duration_since_nopanic() {
    let a = Instant::now();
...
// #[test]
#[cfg(unix)]
pub fn system_time_duration_since_max_range_on_unix() {
