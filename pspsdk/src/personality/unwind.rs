...
// and RFC 2841
#[cfg_attr(
    all(any(target_os = "fuchsia", target_os = "linux")),
    ...
    any(target_vendor = "apple", target_os = "netbsd", not(target_arch = "arm")) => {
        ...
        unsafe extern "C" {
            ...
            pub fn _Unwind_GetIPInfo(
                ctx: *mut _Unwind_Context, ip_before_insn: *mut c_int,
            ) -> _Unwind_Word;
        }
    },
    _ => {
        ...
        unsafe extern "C" {
            fn _Unwind_VRS_Get(
                ctx: *mut _Unwind_Context, regclass: _Unwind_VRS_RegClass, regno: _Unwind_Word,
                repr: _Unwind_VRS_DataRepresentation, data: *mut c_void,
            ) -> _Unwind_VRS_Result;
        ...
        pub unsafe fn _Unwind_SetGR(
            ctx: *mut _Unwind_Context, reg_index: c_int, value: _Unwind_Word,
        ) {
            let mut value = value;
            unsafe {
                _Unwind_VRS_Set(
    ...
    any(
        ...
        unsafe extern "C" {
            pub fn _GCC_specific_handler(
                exceptionRecord: *mut EXCEPTION_RECORD, establisherFrame: LPVOID,
                contextRecord: *mut CONTEXT, dispatcherContext: *mut DISPATCHER_CONTEXT,
