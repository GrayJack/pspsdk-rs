...
#[psp_stub(libname = "sceAudioRouting", flags = 0x4001, version = (0x00, 0x17), use_crate)]
extern "C" {
...
#[cfg(feature = "kernel")]
#[psp_stub(libname = "sceAudioRouting_driver", flags = 0x0001, version = (0x00, 0x17), use_crate)]
extern "C" {
    /// Gets the current audio routing mode.
    ///
    /// # Return Values
